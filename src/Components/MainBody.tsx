...
import custom from '../../public/Cuttom_Product.jpg'
import social from '../../public/socialmedianetwork.jpg'
import computer from '../../public/computer_engineering.jpg'
import david from '../../public/David.jpg'
import nathan from '../../public/Nathan.jpg'
import mated from '../../public/Mated.jpg'
import jain from '../../public/Jain.jpg'
                ...
                <div className="container">
                    ...
                    <div className="row d-flex justify-content-center">
                        <div className="col-lg-3 col-md-6 mt-4">
                            ...
                            <div className="single_feature p-3"> {/* Adding padding for inner content spacing */}
                                <div className="icon"><FaGraduationCap className='fs-1 text-dark' /></div>
                                <div className="desc">
                        ...
                        <div className="col-lg-3 col-md-6 mt-4">
                            <div className="single_feature p-3">
                                <div className="icon"><SlBookOpen className='fs-1 text-dark' /></div>
                                <div className="desc">
                        ...
                        <div className="col-lg-3 col-md-6 mt-4">
                            <div className="single_feature p-3 ">
                                <div className="icon"><FaGlobeAfrica className='fs-1 text-dark' /></div>
                                <div className="desc">
                    ...
                    <div className="row">
                        ...
                        <div className="owl-stage-outer ">
                            ...
                            <div className="owl-stage d-flex justify-content-center" >
                                ...
                                <div className="owl-item cloned" style={{ width: "555px", marginRight: "30px", backgroundColor: "#f3f4f6" }}>
                                ...
                                <div className="owl-item cloned" style={{ width: "555px", marginRight: "30px", backgroundColor: "#f3f4f6" }}><div className="testi_item">
                                    <div className="row">
                                        <div className="col-lg-4 col-md-6">
